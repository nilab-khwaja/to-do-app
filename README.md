...
>
To-DO APP is an application that use to organize daily works.
...
```
git clone https://github.com/nilab-khwaja/to-do-app
```

- Navigate to the location of the folder in your machine:

**``you@your-Pc-name:~$ cd to-do-app``**
...
Feel free to check the [issues page](https://github.com/nilab-khwaja/to-do-app/issues).
